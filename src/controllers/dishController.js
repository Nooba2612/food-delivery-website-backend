...
class dishController {
  ...
  async createDish(req, res) {
    try {
      const {
        name, category_id, price, stock = 0, discount_amount = 0,
        status = "active", available = true, description, brand,
  ...
  async updateDish(req, res) {
    try {
      ...
      const {
        name, category_id, price, stock, discount_amount,
        status, available, description, thumbnail_path, brand,
        preparation_time, calories,
      } = req.body;
